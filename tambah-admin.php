<?php
    ...
    if(isset($_POST['tambah-admin'])) {
        ...
        $sql = "INSERT INTO admin (nama_admin, username, password) VALUES ('$nama', '$username', '$password')";
        if(mysqli_query($conn, $sql)) {
            echo "<script>alert('Data berhasil ditambahkan!'); window.location.href = 'data-admin.php';</script>";
        }else {
            echo "<script>alert('Data gagal ditambahkan!'); window.location.href = 'tambah-admin.php';</script>";
        }
    }
                ...
                <div class="card-body"><br>
                    <form class="row g-3" action="" method="post">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="inputName5" name="nama_admin" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="text-center">
                            <button type="submit" name="tambah-admin" class="btn btn-primary"
