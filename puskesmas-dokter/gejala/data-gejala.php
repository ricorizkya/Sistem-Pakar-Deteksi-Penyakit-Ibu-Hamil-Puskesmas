...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link " href="../gejala/data-gejala.php">
    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="card">
                <div class="card-header"><a href="tambah-gejala.php" class="btn btn-primary" style="width: 100%;">Tambah
                        Data Gejala</a></div>
                <div class="card-body">
                    <?php
                    ...
                    <table class="table table-hover datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="edit-gejala.php?nomor=<?php echo $row['id_gejala']; ?>"
                                        class="btn btn-success">EDIT</a>
                                    <a href="hapus-gejala.php?nomor=<?php echo $row['id_gejala']; ?>"
