<?php
    ...
    if (isset($_POST['tambah-dokter'])) {
        ...
        $jabatan_dokter = "Dokter Puskesmas Mejobo";
                ...
                <div class="card-body"><br>
                    <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="inputName5" name="nama_dokter" required>
                        </div>
                        <div class="col-md-6">
                            <label for="inputEmail5" class="form-label">Nomor Induk Dokter</label>
                            <input type="number" class="form-control" id="inputEmail5" name="nip_dokter" required>
                        </div>
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="inputName5" name="jabatan_dokter"
                                value="Dokter Puskesmas Mejobo" disabled>
                        </div>
                        <div class="col-md-6">
                            <label for="inputName5" class="form-label">Username Dokter</label>
                            <input type="text" class="form-control" id="inputName5" name="username_dokter" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="file" class="form-control" id="inputEmail5" name="foto_dokter" required>
                        </div>
                        <div class="text-center">
                            <button type="submit" name="tambah-dokter" class="btn btn-primary"
