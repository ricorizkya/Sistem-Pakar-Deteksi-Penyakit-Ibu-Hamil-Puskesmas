...
error_reporting(E_ALL);
    ...
    $idRiwayat = $_GET['nomor'];
    $resultRiwayat = mysqli_query($conn, "SELECT * FROM riwayat WHERE id_riwayat=$idRiwayat");
    $dataRiwayat = mysqli_fetch_assoc($resultRiwayat);
    $tglRiwayat = $dataRiwayat['tgl'];
    $idPasien = $dataRiwayat['id_pasien'];
                ...
                <div class="col">
                    <div class="card info-card revenue-card">
                        <div class="card-body">
                            ...
                            <table>
                                <?php
                                        $queryDataDiri = "SELECT * FROM riwayat LEFT JOIN pasien ON riwayat.id_pasien = pasien.id_pasien LEFT JOIN dokter ON riwayat.id_dokter = dokter.id_dokter WHERE id_riwayat=$idRiwayat";
                            ...
                            <table class="table table-bordered" style="margin-top: 20px;">
                                ...
                                <tbody>
                                    <tr>
                                        <?php
                                                    $gejala_user = "SELECT * FROM gejala_user LEFT JOIN gejala ON gejala_user.id_gejala = gejala.id_gejala LEFT JOIN basis_pengetahuan ON gejala.id_gejala = basis_pengetahuan.id_gejala LEFT JOIN penyakit ON basis_pengetahuan.id_penyakit = penyakit.id_penyakit WHERE tgl='$tglRiwayat' AND id_user='$idPasien'";
                            ...
                            foreach ($new_array as $id) {
                                ...
                                $queryGejala = "SELECT * FROM gejala_user WHERE id_user = '$idPasien' AND tgl = '$tglRiwayat'";
