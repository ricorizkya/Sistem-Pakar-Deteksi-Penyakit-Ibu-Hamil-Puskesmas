<?php
    ...
    $queryBasis = "SELECT * FROM basis_pengetahuan WHERE id_pengetahuan = $id_pengetahuan";
    $resultBasis = mysqli_query($conn, $queryBasis);
    $rowBasis = mysqli_fetch_assoc($resultBasis);

    if(isset($_POST['edit-basis'])) {
        ...
        if(mysqli_query($conn, $sql)) {
            ...
            echo "<script>alert('Data gagal ditambahkan!'); window.location.href = 'tambah-pengetahuan.php';</script>";
        }
    }
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Tambah Data Basis Pengetahuan Penyakit <?= $rowPenyakit['nama_penyakit']; ?></h1>
            <nav style="--bs-breadcrumb-divider: '|';">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="../index.php">Home</a></li>
                    <li class="breadcrumb-item"><a href="data-pengetahuan.php">Data Basis Pengetahuan</a></li>
                    <li class="breadcrumb-item active">Tambah Data Basis Pengetahuan Penyakit
            ...
            <div class="card">
                <div class="card-body"><br>
                    <form class="row g-3" action="" method="post">
                        <div class="col-md-12">
                            <label for="inputName5" class="form-label">Pilih Gejala</label>
                            <div class="col-sm-12">
                                <select class="form-select" aria-label="Default select example" name="id_gejala">
                                    <?php
                                        $queryGejala = "SELECT * FROM gejala";
                                        $resultGejala = mysqli_query($conn, $queryGejala);

                                        if(mysqli_num_rows($resultGejala) > 0){
                                            while($rowGejala = mysqli_fetch_assoc($resultGejala)){
                                    ?>
                                    <option value=<?= $rowGejala['id_gejala']; ?>><?= $rowGejala['kode_gejala']; ?> -
                                        <?= $rowGejala['nama_gejala']; ?></option>
                                    <?php }} ?>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="number" step="any" class="form-control" id="inputEmail5" name="mb"
                                value="<?= $rowBasis['mb']; ?>" required>
                        </div>
                        <div class="col-md-6">
                            <label for="inputPassword5" class="form-label">Masukkan Nilai MD</label>
                            <input ype="number" step="any" class="form-control" id="inputEmail5" name="md"
                                value="<?= $rowBasis['md']; ?>" required>
                        </div>
                        <div class="text-center">
                            <button type="submit" name="edit-basis" class="btn btn-primary"
