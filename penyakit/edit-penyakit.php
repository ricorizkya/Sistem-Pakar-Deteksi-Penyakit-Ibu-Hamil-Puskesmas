<?php
    ...
    if(isset($_POST['edit-penyakit'])) {
        ...
        $sql = "UPDATE penyakit SET kode_penyakit='$kode_penyakit', nama_penyakit='$nama_penyakit', pengertian_penyakit='$pengertian_penyakit', tindak_lanjut='$tindak_lanjut' WHERE id_penyakit=$id_penyakit";
        if(mysqli_query($conn, $sql)) {
            echo "<script>alert('Data berhasil diubah!'); window.location.href = 'data-penyakit.php';</script>";
        }else {
            echo "<script>alert('Data gagal diubah!'); window.location.href = 'edit-penyakit.php';</script>";
        }
    }
                ...
                <div class="card-body"><br>
                    <form class="row g-3" action="" method="post">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="inputName5" name="kode_penyakit"
                                value="<?= $rowPenyakit['kode_penyakit']; ?>" required>
                        </div>
                        <div class="col-md-6">
                            <label for="inputEmail5" class="form-label">Nama Penyakit</label>
                            <input type="text" class="form-control" id="inputEmail5" name="nama_penyakit"
                                value="<?= $rowPenyakit['nama_penyakit']; ?>">
                        </div>
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" id="floatingTextarea" style="height: 100px;"
                                name="pengertian_penyakit"
                                required><?= $rowPenyakit['pengertian_penyakit']; ?></textarea>
                        </div>
                        <div class="col-md-12">
                            <label for="inputPassword5" class="form-label">Tindak Lanjut Penyakit</label>
                            <textarea class="form-control" id="floatingTextarea" style="height: 100px;"
                                name="tindak_lanjut" required><?= $rowPenyakit['tindak_lanjut']; ?></textarea>
                        </div>
                        <div class="text-center">
                            <button type="submit" name="edit-penyakit" class="btn btn-primary"
