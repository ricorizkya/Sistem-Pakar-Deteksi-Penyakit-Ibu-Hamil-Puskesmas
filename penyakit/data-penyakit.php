...
<body>
    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="card">
                <div class="card-header"><a href="tambah-penyakit.php" class="btn btn-primary"
                    ...
                    <table class="table table-hover datatable">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Pengertian Penyakit</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['pengertian_penyakit']; ?></td>
                                <td><?php echo $row['tindak_lanjut']; ?></td>
                                <td>
                                    <a href="edit-penyakit.php?nomor=<?php echo $row['id_penyakit']; ?>"
                                        class="btn btn-success">EDIT</a>
                                    <a href="hapus-penyakit.php?nomor=<?php echo $row['id_penyakit']; ?>"
