                ...
                <div class="card-body"><br>
                    <form class="row g-3" action="" method="post">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="any" class="form-control" id="inputEmail5" name="mb" required>
                        </div>
                        <div class="col-md-6">
                            <label for="inputPassword5" class="form-label">Masukkan Nilai MD</label>
                            <input ype="number" step="any" class="form-control" id="inputEmail5" name="md" required>
                        </div>
                        <div class="text-center">
                            <button type="submit" name="tambah-basis" class="btn btn-primary"
