...
<body>
    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="card">
                <div class="card-header"><a href="tambah-dokter.php" class="btn btn-primary" style="width: 100%;">Tambah
                        Dokter</a></div>
                <div class="card-body">
                    <?php
                    ...
                    <table class="table table-hover datatable">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Nomor Induk Dokter</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="../assets/img/<?= $row['foto_dokter']; ?>" alt=""
                                        style="width: 150px; height: 200px;"></td>
                                <td><?php echo $row['nip_dokter']; ?></td>
                                <td><?php echo $row['nama_dokter']; ?></td>
                                <td><?php echo $row['jabatan']; ?></td>
                                <td><?php echo $row['username_dokter']; ?></td>
                                <td><?php echo $row['password_dokter']; ?></td>
                                <td>
                                    <a href="edit-dokter.php?nomor=<?php echo $row['id_dokter']; ?>"
                                        class="btn btn-success">EDIT</a>
                                    <a href="hapus-dokter.php?nomor=<?php echo $row['id_dokter']; ?>"
